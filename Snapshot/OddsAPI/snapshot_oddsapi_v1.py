...
def print_help():
    print("""
Usage:
  python snapshot_oddsapi.py doctor            Check API key and usage
  python snapshot_oddsapi.py doctor --sports   Check key, then list sports
  python snapshot_oddsapi.py key show          Show saved key (masked)
  python snapshot_oddsapi.py key set           Save a new API key
  python snapshot_oddsapi.py key clear         Delete saved API key
  python snapshot_oddsapi.py snapshot --sports basketball_nba soccer_epl

Examples:
  python snapshot_oddsapi.py doctor
  python snapshot_oddsapi.py snapshot --sports basketball_nba
  python snapshot_oddsapi.py snapshot --sports basketball_nba mma_mixed_martial_arts
""")
...
def main():
    ...
    if sys.argv[1] == "snapshot":
        ...
        parser.add_argument(
            "--sports",
            nargs="+",
            help="List of sports keys (e.g. basketball_nba soccer_epl)"
        )
        ...
        if not args.sports:
            print("❌ No sports specified. Use --sports or --list-sports.")
            return
